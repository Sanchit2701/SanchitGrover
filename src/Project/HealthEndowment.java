...
public class HealthEndowment extends Endowment {
    ...
    public String getHealthCareCenter() { return healthCareCenter; }
    public void setHealthCareCenter(String healthCareCenter) { this.healthCareCenter = healthCareCenter; }
    ...
    public double calculateEndowment() {
        if (holderAge <= 30) return 120000;
        else if (holderAge < 60) return 200000;
        else return 500000;
    }
}
