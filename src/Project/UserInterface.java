...
public class UserInterface {
    public static void main(String[] args) {
        ...
        if (type.equalsIgnoreCase("educational")) {
            ...
            EducationalEndowment edu = new EducationalEndowment(id, name, type, date, institution, division);
            double amount = edu.calculateEndowment();
            ...
            HealthEndowment health = new HealthEndowment(id, name, type, date, center, age);
            double amount = health.calculateEndowment();
            System.out.printf("Endowment Amount %.2f", amount);
